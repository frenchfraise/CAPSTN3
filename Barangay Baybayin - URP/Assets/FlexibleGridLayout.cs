...
public class FlexibleGridLayout : LayoutGroup
{
    ...
    //    layout.padding.right = (int)(layout.padding.right / (Camera.main.aspect / defaultRatio16_9));
    //    layout.padding.top = (int)(layout.padding.top / (Camera.main.aspect / defaultRatio16_9));
    //    layout.padding.bottom = (int)(layout.padding.bottom / (Camera.main.aspect / defaultRatio16_9));
    ...
    //cellWidth = (parent.width - (spacing.x* ((float) columns - 1)) - padding.left - padding.right) / (float) columns;

    //you first get sum of all sizes and then divide it in columns count.

    //if (GetComponent<ContentSizeFitter>() != null)
    //       {
    //           var totalMinWidth = (rectChildren.Count * (cellSize.x + spacing.x)) + padding.left + padding.right;
    //var totalMinHeight = (rectChildren.Count * (cellSize.y + spacing.y)) + padding.top + padding.bottom;
