...
[System.Serializable]
public class CritMeterIncrease : UnityEvent<float, float> { }


public class CritMeterFull : UnityEvent { }


public class CritMeterEmpty : UnityEvent { }
...
public class ToolCrit : MonoBehaviour
{
    ...
    public CritMeterIncrease OnCritMeterIncrease = new CritMeterIncrease();
